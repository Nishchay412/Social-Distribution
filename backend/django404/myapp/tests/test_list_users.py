...
class ListUsersAPITestCase(APITestCase):
    def setUp(self):
        ...
        self.test_user1 = User.objects.create_user(username='test1', password='test123')
        self.test_user2 = User.objects.create_user(username='test2', password='test123')
        self.test_admin2 = User.objects.create_user(username='admin2', password='admin123')
